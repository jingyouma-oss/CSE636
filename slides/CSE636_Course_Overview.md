...
California Science and Technology University · Fall 2025
...
Students move beyond using AI as a passive assistant to designing agentic systems that perceive, plan, use tools,

and act across the software delivery lifecycle — with guardrails and human oversight.
...
This course explores how AI, ML, and autonomous AI agents are integrated into DevOps to automate,

optimize, and enhance software development and operations.
...
1. Explain how AI agents & ML augment DevOps across levels of autonomy (assistant → human-in-

loop → human-on-loop → autonomous).
...
qingsong.zhang@cstu.edu

Wed 7:30–9:00pm (Online) · Sat 9:00–10:30am (Onsite)
...
Python; basic computing; Git & Docker recommended. No prior ML/LLM experience required.
...
Responsible AI-tool use: students are expected to use AI agents in labs — and to disclose and critically evaluate
...
Claude Code, Cursor, Copilot, Devin, Codex; AIOps platforms (Datadog, New Relic, Dynatrace,
PagerDuty)
...
Lab: Python agent (MCP tools) triages a simulated incident → gated remediation · Assignment: self-healing microservice with
...
Capstone: agent-augmented IaC + end-to-end agentic DevOps project (pipeline → deploy → observe → auto-remediate, with
...
AI coding agents/assistants are permitted and expected in designated labs — but must be
disclosed.

Students remain fully responsible for correctness, security, and originality of all submitted work,
