...
**Arc placement:** This is the pivot week. [Week 2](week-02-notes.md) gave you the *tools* — MCP servers, agent frameworks, coding agents. Now those tools move off the workbench and into the assembly line. By the end of today you will understand how to wire an agent into every stage of a CI/CD pipeline *and* how to make sure it cannot break production without a human saying so. [Week 4](week-04-notes.md) will build on this by adding predictive analytics: instead of reacting to failures after they occur, the pipeline will start forecasting them.

**Builds on:** [Week 2](week-02-notes.md) — MCP protocol, agent tooling, permission management.
...
- [Week 2: AI Agent Tooling, Protocols & Platforms](week-02-notes.md) — MCP, agent frameworks, permission management (prerequisite)
- [Week 4: Predictive Analytics & Capacity Intelligence](week-04-notes.md) — What this week's data feeds into
